...
-- Tiempo de generación: 18-11-2022 a las 04:20:58
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `AgregarCurso` (IN `pNombre` VARCHAR(15), IN `pModalidad` VARCHAR(20), IN `pNaturaleza` VARCHAR(24), IN `pCreditos` INT, IN `pAsistencia` VARCHAR(20), IN `pDuracion` VARCHAR(60))   BEGIN
...
CREATE TABLE `cursos` (
  ...
  `naturaleza` varchar(24) NOT NULL,
...
INSERT INTO `cursos` (`idCurso`, `nombre`, `modalidad`, `naturaleza`, `creditos`, `asistencia`, `duracion`) VALUES
(1, 'Programacion', 'Cuatrimestral', 'Teorico', 3, 'Virtual', '15 Semanas'),
(2, 'Electronica', 'Semestral', 'Practico', 4, 'Presencial', '14 Semanas');
