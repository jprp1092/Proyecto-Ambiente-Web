...
-- Tiempo de generación: 18-11-2022 a las 05:10:01
...
INSERT INTO cursos (nombre,modalidad,horario,creditos,docente) VALUES ('Programación','Virtual','Mañana',5,2);
...
ALTER TABLE `cursos`
  ...
  ADD KEY `fk_asociar_profe` (`docente`);
...
--
ALTER TABLE `cursos`
  ADD CONSTRAINT `fk_asociar_profe` FOREIGN KEY (`docente`) REFERENCES `usuarios` (`idUsuario`);
